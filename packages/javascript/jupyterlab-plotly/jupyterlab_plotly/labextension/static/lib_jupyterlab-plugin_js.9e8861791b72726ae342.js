"use strict";
(self["webpackChunkjupyterlab_plotly"] = self["webpackChunkjupyterlab_plotly"] || []).push([["lib_jupyterlab-plugin_js"],{
...
/* harmony import */ var plotly_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! plotly.js */ "webpack/sharing/consume/default/plotly.js/plotly.js");
...
class FigureModel {
    ...
    get(key) {
        ...
        if (serializer === null || serializer === void 0 ? void 0 : serializer.deserialize) {
    ...
    set(key, value) {
        ...
        if (serializer === null || serializer === void 0 ? void 0 : serializer.serialize) {
    ...
    _normalize_trace_indexes(trace_indexes) {
        if (trace_indexes === null || trace_indexes === undefined) {
            ...
            trace_indexes = lodash__WEBPACK_IMPORTED_MODULE_0___default().range(numTraces);
        }
        if (trace_indexes !== undefined && trace_indexes !== null && !Array.isArray(trace_indexes)) {
            // Make sure idx is an array
            trace_indexes = [trace_indexes];
        }
        return trace_indexes !== null && trace_indexes !== void 0 ? trace_indexes : [];
    }
    /**
    ...
    do_addTraces() {
        ...
        if (msgData !== null) {
            ...
            lodash__WEBPACK_IMPORTED_MODULE_0___default().forEach(newTraces, function (newTrace) {
    ...
    do_removeLayoutProps() {
        ...
        var msgData = this.model.get("_py2js_removeLayoutProps");
        if (msgData !== null) {
...
class FigureView {
    ...
    perform_render() {
        ...
        // ---------------------
        (_c = (_b = (_a = window === null || window === void 0 ? void 0 : window.MathJax) === null || _a === void 0 ? void 0 : _a.Hub) === null || _b === void 0 ? void 0 : _b.Config) === null || _c === void 0 ? void 0 : _c.call(_b, { SVG: { font: "STIX-Web" } });
        // Get message ids
        // ---------------------
        ...
        var initialTraces = lodash__WEBPACK_IMPORTED_MODULE_0___default().cloneDeep(this.model.get("_data"));
        var initialLayout = lodash__WEBPACK_IMPORTED_MODULE_0___default().cloneDeep(this.model.get("_layout"));
        if (!initialLayout.height) {
            initialLayout.height = 360;
        }
        var config = this.model.get("_config");
        config.editSelection = false;
        plotly_js__WEBPACK_IMPORTED_MODULE_1___default().newPlot(that.el, initialTraces, initialLayout, config).then(function () {
            // ### Send trace deltas ###
    ...
    _processLuminoMessage(msg, _super) {
        ...
        switch (msg.type) {
            case "before-attach":
                ...
                plotly_js__WEBPACK_IMPORTED_MODULE_1___default().newPlot(that.el, [], {
                    xaxis: axisHidden,
                    yaxis: axisHidden,
                });
                this.resizeEventListener = () => {
    ...
    autosizeFigure() {
        ...
        if (lodash__WEBPACK_IMPORTED_MODULE_0___default().isNil(layout) || lodash__WEBPACK_IMPORTED_MODULE_0___default().isNil(layout.width)) {
            // @ts-ignore
            plotly_js__WEBPACK_IMPORTED_MODULE_1___default().Plots.resize(that.el).then(function () {
     ...
     */
    remove() {
        plotly_js__WEBPACK_IMPORTED_MODULE_1___default().purge(this.el);
    ...
    do_addTraces() {
        ...
        if (msgData !== null) {
            var that = this;
            plotly_js__WEBPACK_IMPORTED_MODULE_1___default().addTraces(this.el, msgData.trace_data).then(function () {
                // ### Send trace deltas ###
    ...
    do_deleteTraces() {
        ...
        if (msgData !== null) {
            var delete_inds = msgData.delete_inds;
            var that = this;
            plotly_js__WEBPACK_IMPORTED_MODULE_1___default().deleteTraces(this.el, delete_inds).then(function () {
                // ### Send trace deltas ###
    ...
    do_moveTraces() {
        ...
        if (msgData !== null) {
            ...
            // the current indexes
            var inds_equal = lodash__WEBPACK_IMPORTED_MODULE_0___default().isEqual(currentInds, newInds);
            if (!inds_equal) {
                plotly_js__WEBPACK_IMPORTED_MODULE_1___default().moveTraces(this.el, currentInds, newInds);
            }
        }
    }
    /**
    ...
    do_restyle() {
        ...
        if (msgData !== null) {
            ...
            plotly_js__WEBPACK_IMPORTED_MODULE_1___default().restyle(this.el, restyleData, traceIndexes);
            // ### Send trace deltas ###
    ...
    do_relayout() {
        ...
        if (msgData !== null) {
            if (msgData.source_view_id !== this.viewID) {
                ...
                plotly_js__WEBPACK_IMPORTED_MODULE_1___default().relayout(this.el, msgData.relayout_data);
            }
            // ### Send layout delta ###
            var layout_edit_id = msgData.layout_edit_id;
            this._sendLayoutDelta(layout_edit_id);
    ...
    do_update() {
        ...
        if (msgData !== null) {
            ...
            plotly_js__WEBPACK_IMPORTED_MODULE_1___default().update(this.el, style, layout, traceIndexes);
            // ### Send trace deltas ###
    ...
    do_animate() {
        ...
        if (msgData !== null) {
            ...
            var that = this;
            // @ts-ignore
            plotly_js__WEBPACK_IMPORTED_MODULE_1___default().animate(this.el, animationData, animationOpts).then(function () {
                // ### Send trace deltas ###
    ...
    _sendTraceDeltas(trace_edit_id) {
        ...
        var traceIndexes = lodash__WEBPACK_IMPORTED_MODULE_0___default().range(trace_data.length);
...
function js2py_serializer(v, widgetManager) {
    var res;
    if (lodash__WEBPACK_IMPORTED_MODULE_0___default().isTypedArray(v)) {
...
function py2js_deserializer(v, widgetManager) {
    ...
    if (Array.isArray(v)) {
        ...
        if ((lodash__WEBPACK_IMPORTED_MODULE_0___default().has(v, "value") || lodash__WEBPACK_IMPORTED_MODULE_0___default().has(v, "buffer")) &&
            lodash__WEBPACK_IMPORTED_MODULE_0___default().has(v, "dtype") &&
            lodash__WEBPACK_IMPORTED_MODULE_0___default().has(v, "shape")) {
            ...
            var buffer = lodash__WEBPACK_IMPORTED_MODULE_0___default().has(v, "value") ? v.value.buffer : v.buffer.buffer;
...
function performRelayoutLike(parentObj, relayoutData) {
    ...
    for (var rawKey in relayoutData) {
        ...
        // Set property value
        if (relayoutVal === null) {
            lodash__WEBPACK_IMPORTED_MODULE_0___default().unset(parentObj, rawKey);
        }
        else {
            lodash__WEBPACK_IMPORTED_MODULE_0___default().set(parentObj, rawKey, relayoutVal);
        }
    }
}
/**
...
function performRestyleLike(parentArray, restyleData, restyleTraces) {
    ...
    for (var rawKey in restyleData) {
        ...
        for (var i = 0; i < restyleTraces.length; i++) {
            ...
            // Set property value
            if (singleVal === null) {
                lodash__WEBPACK_IMPORTED_MODULE_0___default().unset(trace, rawKey);
            }
            else if (singleVal !== undefined) {
                lodash__WEBPACK_IMPORTED_MODULE_0___default().set(trace, rawKey, singleVal);
            }
        }
    }
}
...
function performMoveTracesLike(parentArray, currentInds, newInds) {
    ...
    var newIndexSortedArrays = lodash__WEBPACK_IMPORTED_MODULE_0___default()(newInds)
...
function performRemoveProps(parentObj, keyPaths) {
    for (var i = 0; i < keyPaths.length; i++) {
        ...
        lodash__WEBPACK_IMPORTED_MODULE_0___default().unset(parentObj, keyPath);
    }
}
/**
...
function createDeltaObject(fullObj, removeObj) {
    ...
    for (var p in fullObj) {
        ...
        // have the property
            ...
            var props_equal;
            props_equal = lodash__WEBPACK_IMPORTED_MODULE_0___default().isEqual(fullObj[p], removeObj[p]);
...
function randstr(existing, bits, base, _recursion) {
    ...
    if ((existing && existing[res]) ||
        ...
        if ((_recursion !== null && _recursion !== void 0 ? _recursion : 0) > 10) {
...
/* harmony import */ var _Figure__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Figure */ "./lib/Figure.js");
...
function activateWidgetExtension(app, registry) {
    registry.registerWidget({
        ...
        exports: {
            FigureModel: _Figure__WEBPACK_IMPORTED_MODULE_2__.FigureModel,
            FigureView: _Figure__WEBPACK_IMPORTED_MODULE_2__.FigureView,
        }
    });
}
/**
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (widgetPlugin);
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"jupyterlab-plotly","version":"5.22.0","description":"The plotly Jupyter extension","author":"The plotly.py team","license":"MIT","main":"lib/index.js","repository":{"type":"git","url":"https://github.com/plotly/plotly.py"},"keywords":["jupyter","widgets","ipython","ipywidgets","plotly"],"files":["lib/**/*.js","dist/*.js","style/*.*","style/index.js"],"scripts":{"build":"jlpm build:lib && jlpm build:labextension:dev","build:dev":"npm run build:lib && npm run build:nbextension && npm run build:labextension:dev","build:labextension":"jupyter labextension build .","build:labextension:dev":"jupyter labextension build --development True .","build:lib":"tsc --sourceMap","build:lib:prod":"tsc","build:nbextension":"webpack --mode=production","build:prod":"jlpm clean && jlpm build:lib:prod && jlpm build:labextension","clean":"jlpm clean:lib","clean:all":"jlpm clean:lib && jlpm clean:labextension && jlpm clean:lintcache","clean:labextension":"rimraf jupyterlab_plotly/labextension jupyterlab_plotly/_version.py","clean:lib":"rimraf lib tsconfig.tsbuildinfo","clean:lintcache":"rimraf .eslintcache .stylelintcache","clean:nbextension":"rimraf ../../python/plotly/jupyterlab_plotly/nbextension/index.js*","eslint":"jlpm eslint:check --fix","eslint:check":"eslint . --cache --ext .ts,.tsx","install:extension":"jlpm build","lint":"jlpm stylelint && jlpm prettier && jlpm eslint","lint:check":"jlpm stylelint:check && jlpm prettier:check && jlpm eslint:check","prepack":"npm run build:lib","prettier":"jlpm prettier:base --write --list-different","prettier:base":"prettier \\"**/*{.ts,.tsx,.js,.jsx,.css,.json,.md}\\"","prettier:check":"jlpm prettier:base --check","stylelint":"jlpm stylelint:check --fix","stylelint:check":"stylelint --cache \\"style/**/*.css\\"","test":"echo \\"Error: no test specified\\" && exit 1","watch":"run-p watch:src watch:labextension","watch:labextension":"jupyter labextension watch .","watch:lib":"tsc -w","watch:nbextension":"webpack --watch","watch:src":"tsc -w --sourceMap"},"devDependencies":{"@jupyterlab/application":"^4.2.3","@jupyterlab/builder":"^4.0.0","@lumino/application":"^2.3.0-alpha.0","@types/json-schema":"^7.0.11","@types/plotly.js":"^1.54.22","@types/react":"^18.0.26","@types/react-addons-linked-state-mixin":"^0.14.22","@types/webpack-env":"^1.13.6","@typescript-eslint/eslint-plugin":"^6.1.0","@typescript-eslint/parser":"^6.1.0","acorn":"^7.2.0","css-loader":"^6.7.1","eslint":"^8.36.0","eslint-config-prettier":"^8.8.0","eslint-plugin-prettier":"^5.0.0","fs-extra":"^7.0.0","mkdirp":"^0.5.1","npm-run-all":"^4.1.5","prettier":"^3.0.0","rimraf":"^5.0.1","source-map-loader":"^1.0.2","style-loader":"^3.3.1","stylelint":"^15.10.1","stylelint-config-recommended":"^13.0.0","stylelint-config-standard":"^34.0.0","stylelint-csstree-validator":"^3.0.0","stylelint-prettier":"^4.0.0","ts-loader":"^8.0.0","typescript":"~5.0.2","webpack":"^5.0.0","webpack-cli":"^4.0.0","yjs":"^13.5.40"},"dependencies":{"@jupyter-widgets/base":">=2.0.0 <7.0.0","@jupyterlab/rendermime-interfaces":"^3.10.3","@lumino/messaging":"^2.0.0","@lumino/widgets":"^2.3.1-alpha.0","assert":"^2.1.0","lodash":"^4.17.4","plotly.js":"^2.32.0","stream":"^0.0.3"},"jupyterlab":{"extension":"lib/jupyterlab-plugin","mimeExtension":"lib/plotly-renderer","outputDir":"jupyterlab_plotly/labextension","sharedPackages":{"@jupyter-widgets/base":{"bundled":false,"singleton":true}}},"eslintConfig":{"extends":["eslint:recommended","plugin:@typescript-eslint/eslint-recommended","plugin:@typescript-eslint/recommended","plugin:prettier/recommended"],"parser":"@typescript-eslint/parser","parserOptions":{"project":"tsconfig.json","sourceType":"module"},"plugins":["@typescript-eslint"],"rules":{"@typescript-eslint/naming-convention":["error",{"selector":"interface","format":["PascalCase"],"custom":{"regex":"^I[A-Z]","match":true}}],"@typescript-eslint/no-unused-vars":["warn",{"args":"none"}],"@typescript-eslint/no-explicit-any":"off","@typescript-eslint/no-namespace":"off","@typescript-eslint/no-use-before-define":"off","@typescript-eslint/quotes":["error","single",{"avoidEscape":true,"allowTemplateLiterals":false}],"curly":["error","all"],"eqeqeq":"error","prefer-arrow-callback":"error"}},"eslintIgnore":["node_modules","dist","coverage","**/*.d.ts"],"prettier":{"singleQuote":true,"trailingComma":"none","arrowParens":"avoid","endOfLine":"auto","overrides":[{"files":"package.json","options":{"tabWidth":4}}]},"stylelint":{"extends":["stylelint-config-recommended","stylelint-config-standard","stylelint-prettier/recommended"],"plugins":["stylelint-csstree-validator"],"rules":{"csstree/validator":true,"property-no-vendor-prefix":null,"selector-class-pattern":"^([a-z][A-z\\\\d]*)(-[A-z\\\\d]+)*$","selector-no-vendor-prefix":null,"value-no-vendor-prefix":null}},"styleModule":"style/index.js","packageManager":"yarn@4.3.1"}');

/***/ })

}]);
//# sourceMappingURL=lib_jupyterlab-plugin_js.9e8861791b72726ae342.js.map